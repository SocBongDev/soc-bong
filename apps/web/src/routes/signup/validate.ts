...
export const CreateUserSchema = z.object({
    ...
    dob: z.string().nonempty({ message: "ngày tháng năm sinh không được để trống" }),
    first_name: z.string().nonempty({ message: "Tên không được để trống" }),
    last_name: z.string().nonempty({ message: "Họ không được để trống" }),
